    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <main className="max-w-2xl text-center space-y-8">
        ...
        <p className="text-lg text-slate-600">
          AI-powered code refactoring in your editor. Rename symbols, extract
          functions, and restructure code with confidence.
        </p>
        <div>
          {canRequest ? (
            <a href={requestAccessUrl}>
              <Button className="text-base px-6 py-3">Request access</Button>
            </a>
          ) : (
